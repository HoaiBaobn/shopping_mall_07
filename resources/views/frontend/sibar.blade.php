<div class="col-xs-12 col-md-3 sibar">
    ...
    <div class="block-content">
        ...
        <li class="level0 parent drop-menu ">
            ...
            <ul class="level1">
                <li class="level1"><a href="/ao-nu"><span>Áo nữ</span></a></li>
                <li class="level1"><a href="/quan-nu"><span>Quần nữ</span></a></li>
                <li class="level1"><a href="/dam-vay"><span>Đầm,váy</span></a></li>
                <li class="level1"><a href="/set-trang-phuc-jumpsuit"><span>Set trang phục, jumpsuit</span></a></li>
    ...
    <div class="online_support block">
        <div class="block-title">
            <h5>{{Lang::get('custom.homepage.help')}}</h5>
        </div>
        <div class="block-content">
            <div class="sp_1">
                <p><b>{{Lang::get('custom.homepage.support')}} 1</b></p>
                <p>Mrs. Bão  <span>0971 885 136</span></p>
            </div>
            <div class="sp_2">
                <p>{{Lang::get('custom.homepage.support')}} 2</p>
                <p>Mrs. Bão  <span>0971 885 136</span></p>
            </div>
            <div class="sp_mail">
                <p>Email liên hệ</p>
    ...
    <div class="best_product block">
        <div class="block-title">
            <h5>{{Lang::get('custom.homepage.care')}}</h5>
        </div>
                ...
                <div class="item cat-slide-item"> 
                    ...
                    <div class="item item_pd">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 item-img">
                            <a href="/trangchu/<?=$pronew->pro_id;?>"><img src="{{url('uploads').'/'.$pronew->img}}"  width="81" height="81" alt="Sản phẩm demo"></a>
                        </div>
    ...
    <img src="uploads/banner.jpg" alt="lỗi ok" width="100%">
</div>